- LOW HUB - HONEY SEED NPC TELEPORT
    ...
    local function getHoneySeedNPC()
        ...
        if not npcs then
            npcs = workspace:WaitForChild(NPC_PATH_1, 5)
        end
    ...
    Main.Name = "Main"
    Main.Size = UDim2.new(0, 360, 0, 305)
    Main.Position = UDim2.new(0, 30, 0.5, -152)
    ...
    local OpenShopBtn = makeButton("OpenHoneySeedShop", "Open Honey Seed Shop UI", 240, Color3.fromRGB(55, 45, 35))
    local PosBtn = makeButton("PrintPosition", "Print Position", 280, Color3.fromRGB(35, 45, 55))
